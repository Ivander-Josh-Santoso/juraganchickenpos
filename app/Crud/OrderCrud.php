...
class OrderCrud extends CrudService
{
    ...
    **/
    ...
    {
        return [
            'list_title'             =>  __( 'Daftar Pesanan' ),
            'list_description'       =>  __( 'Tampilkan semua pesanan.' ),
            'no_entry'               =>  __( 'Belum ada pesanan yang terdaftar' ),
            'create_new'             =>  __( 'Tambah pesanan baru' ),
            'create_title'           =>  __( 'Buat pesanan baru' ),
            'create_description'     =>  __( 'Daftarkan pesanan baru dan simpan.' ),
            'edit_title'             =>  __( 'Ubah pesanan' ),
            'edit_description'       =>  __( 'Modifikasi Pesanan.' ),
            'back_to_list'           =>  __( 'Kembali ke Daftar Pesanan' ),
