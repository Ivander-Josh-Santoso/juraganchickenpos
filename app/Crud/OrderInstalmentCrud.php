...
class OrderInstalmentCrud extends CrudService
{
    ...
    **/
    ...
    {
        return [
        'list_title'            =>  __( 'Daftar Cicilan Pesanan' ),
        'list_description'      =>  __( 'Menampilkan semua Cicilan Pesanan.' ),
        'no_entry'              =>  __( 'Belum ada Cicilan Pesanan yang terdaftar' ),
        'create_new'            =>  __( 'Tambah Cicilan Pesanan Baru' ),
        'create_title'          =>  __( 'Buat Cicilan Pesanan Baru' ),
        'create_description'    =>  __( 'Daftarkan Cicilan Pesanan baru dan simpan.' ),
        'edit_title'            =>  __( 'Ubah Cicilan Pesanan' ),
        'edit_description'      =>  __( 'Modifikasi Cicilan Pesanan.' ),
        'back_to_list'          =>  __( 'Kembali ke Cicilan Pesanan' ),
        ];
    }
