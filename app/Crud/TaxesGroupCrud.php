...
class TaxesGroupCrud extends CrudService
{
    ...
    {
        return [
            'list_title'             =>  __( 'Daftar Grup Pajak' ),
            'list_description'       =>  __( 'Tampilkan semua grup pajak.' ),
            'no_entry'               =>  __( 'Belum ada grup pajak yang terdaftar' ),
            'create_new'             =>  __( 'Tambah grup pajak baru' ),
            'create_title'           =>  __( 'Buat grup pajak baru' ),
            'create_description'     =>  __( 'Daftarkan grup pajak baru dan simpan.' ),
            'edit_title'             =>  __( 'Ubah grup pajak' ),
            'edit_description'       =>  __( 'Modifikasi Grup Pajak.' ),
            'back_to_list'           =>  __( 'Kembali ke Grup Pajak' ),
        ];
    }
                ...
                'general'   =>  [
                    ...
                    'fields'    =>  [
                        [
                            ...
                            'label'         =>  __( 'Deskripsi' ),
                            'description'   =>  __( 'Berikan deskripsi singkat untuk grup pajak.' ),
                        ]
                    ]
                ]
            ]
