...
class PaymentTypeCrud extends CrudService
{
    ...
    **/
    ...
    {
        return [
            'list_title'             =>  __( 'Daftar Jenis Pembayaran' ),
            'list_description'       =>  __( 'Tampilkan semua jenis pembayaran.' ),
            'no_entry'               =>  __( 'Belum ada jenis pembayaran yang terdaftar' ),
            'create_new'             =>  __( 'Tambah jenis pembayaran baru' ),
            'create_title'           =>  __( 'Buat jenis pembayaran baru' ),
            'create_description'     =>  __( 'Daftarkan jenis pembayaran baru dan simpan.' ),
            'edit_title'             =>  __( 'Ubah jenis pembayaran' ),
            'edit_description'       =>  __( 'Modifikasi Jenis Pembayaran.' ),
            'back_to_list'           =>  __( 'Kembali ke Daftar Jenis Pembayaran' ),
