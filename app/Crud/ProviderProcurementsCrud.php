...
class ProviderProcurementsCrud extends CrudService
{
    ...
    {
        return [
            'list_title'             =>  __( 'Daftar Pengadaan Penyedia' ),
            'list_description'       =>  __( 'Tampilkan semua pengadaan dari penyedia.' ),
            'no_entry'               =>  __( 'Belum ada pengadaan penyedia yang terdaftar' ),
            'create_new'             =>  __( 'Tambah pengadaan penyedia baru' ),
            'create_title'           =>  __( 'Buat pengadaan penyedia baru' ),
            'create_description'     =>  __( 'Daftarkan pengadaan penyedia baru dan simpan.' ),
            'edit_title'             =>  __( 'Ubah pengadaan penyedia' ),
            'edit_description'       =>  __( 'Modifikasi Pengadaan Penyedia.' ),
            'back_to_list'           =>  __( 'Kembali ke Pengadaan Penyedia' ),
        ];
    }
