...
class GenerateModuleCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Create a new Juragan Chicken POS module';
    ...
    public function handle()
    {
        if ( ns()->installed() ) {
            ...
            $this->info( 'Juragan Chicken POS is not yet installed.' );
        }
    }
    ...
    public function generateModule()
    {
        if ( ! $this->modules->get( $this->module[ 'namespace' ] ) ) {
            ...
            Storage::disk( 'ns-modules' )->makeDirectory( $this->module[ 'namespace' ] . DIRECTORY_SEPARATOR . 'Migrations' . DIRECTORY_SEPARATOR . '1.0' );
