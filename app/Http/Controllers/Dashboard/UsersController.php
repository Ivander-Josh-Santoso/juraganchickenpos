...
class UsersController extends DashboardController
{
    ...
    public function listUsers()
    {
        ...
        return $this->view( 'pages.dashboard.crud.table', [
            'title'         =>      __( 'Daftar Pengguna' ),
            'createUrl'     =>  url( '/dashboard/users/create' ),
            'description'   =>  __( 'Kelola semua pengguna yang tersedia.' ),
    ...
    public function permissionManager()
    {
        ...
        return $this->view( 'pages.dashboard.users.permission-manager', [
            'title'         =>  __( 'Manajer Izin' ),
            'description'   =>  __( 'Kelola semua izin dan peran' )
        ]);
    }
    ...
    public function getProfile()
    {
        ...
        return $this->view( 'pages.dashboard.users.profile', [
            'title'         =>  __( 'Profil Saya' ),
            'description'   =>  __( 'Ubah setelan personal saya' ),
    ...
    public function updateRole( Request $request )
    {
        ...
        return [
            'status'    =>  'success',
            'message'   =>  __( 'Izin telah diperbarui.' )
        ];
    }
