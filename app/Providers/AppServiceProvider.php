...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        echo '<script src="' . asset('js/billing-shipping.js') . '"></script>';
    });
    }
    ...
    protected function loadConfiguration()
    {
        config([ 'nexopos.orders.statuses'      => [
            Order::PAYMENT_HOLD                 => __( 'Ditahan' ),
            Order::PAYMENT_UNPAID               => __( 'Belum Dibayar' ),
            Order::PAYMENT_PARTIALLY            => __( 'Dibayar Sebagian' ),
            Order::PAYMENT_PAID                 => __( 'Lunas' ),
            Order::PAYMENT_VOID                 => __( 'Dibatalkan' ),
            Order::PAYMENT_REFUNDED             => __( 'Dikembalikan' ),
            Order::PAYMENT_PARTIALLY_REFUNDED   => __( 'Dikembalikan Sebagian' ),
        ]]);

        config([ 'nexopos.orders.types'         =>  Hook::filter( 'ns-orders-types', [
            'takeaway'          =>  [
                'identifier'    =>  'takeaway',
                'label'         =>  __( 'Dibawa Pulang' ),
                'icon'          =>  '/images/groceries.png',
                'selected'      =>  false
            ], 
            'delivery'          =>  [
                'identifier'    =>  'delivery',
                'label'         =>  __( 'Pesan Antar' ),
