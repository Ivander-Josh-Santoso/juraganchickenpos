                        ...
                        <div class="my-4 flex justify-between w-full">
                            <div class="text-gray-600">
                                <ul>
                                    ...
                                    <li class="pb-1 border-b border-dashed border-gray-200">{{ __( 'Dokumen : Profit Report' ) }}</li>
                            ...
                            <table class="table w-full">
                                ...
                                <tbody class="text-gray-700">
                                    <tr v-for="product of products" :key="product.id" :class="product.total_price - product.total_purchase_price < 0 ? 'bg-red-100' : 'bg-white'">
                                        <td class="p-2 border border-blue-200">@{{ product.name }}</td>
                                        <td class="p-2 border text-right border-blue-200">@{{ product.unit_name }}</td>
