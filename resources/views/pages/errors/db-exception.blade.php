        ...
        <div class="w-full md:w-1/2 xl:1/3 flex items-center flex-col justify-center">
            ...
            <div class="my-2 shadow overflow-hidden rounded bg-white w-95vw md:w-3/4 lg:w-3/5">
                ...
                <div class="p-4 text-gray-600 text-center text-sm">
                    {{ __( 'JuraganChickenPos wasn\'t able to perform a database request. This error might be related to a misconfiguration on your .env file. The following guide might be useful to help you solving this issue.' ) }}
                </div>
            ...
            <div class="flex md:flex-row flex-col -mx-4 my-4 flex-wrap w-56 lg:w-auto">
                ...
                <div class="px-4 mb-4"><a class="block w-full lg:w-auto btn bg-white text-gray-700" href="{{ url( '/do-setup' ) }}"><i class="las la-cog"></i> {{ __( 'Setup' ) }}</a></div>
            </div>
        </div>
    </div>
@endsection