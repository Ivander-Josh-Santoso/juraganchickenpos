    ...
    <div class="container mx-auto flex-auto items-center justify-center flex">
        <div id="sign-in-box" class="w-full md:w-2/3 lg:w-1/3">
            ...
            <div class="my-3 rounded shadow bg-white">
                ...
                <div class="p-2">
                    <p class="text-center text-sm text-gray-600 py-4">In order to keep uraganChickenPos running smoothly with updates, we need to proceed to the database migration. In fact you don't need to do any action, just wait until the process is done and you'll be redirected.</p>
